    ...
    <table>
        ...
        <tbody>
            <tr v-for="(city, index) in cities" :key="index">
                <td>{{city.name}}</td>
                <td><btn-styled class="btnEdit" @click="editCity(city.id,city.name,index)">Edit</btn-styled></td>
                <td><btn-styled class="btnDelete" @click="removeCity(city.id,index)">Remove</btn-styled></td>
            </tr>
        </tbody>
    </table>
</section>
