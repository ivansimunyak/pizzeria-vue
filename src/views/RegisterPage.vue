...
<div id="wrapper">
    ...
    <b><label>Enter your name:</label></b><br>
        <input id="name" type="text" maxlength="25" name="name" pattern="[A-z]+" v-model="addingName" required><br>
     <b><label>Enter your email:</label></b><br>
    <input id="email" type="email" maxlength="49" name="email" v-model="addingEmail" required><br>
    <b><label>Enter your password:</label></b><br>
    <input id="password" type="password" name="password" maxlength="25" v-model="addingPassword" required><br>
    <b><label >Repeat your password:</label></b><br>
    <input id="rptpassword" type="password" name="rptpassword" maxlength="25" v-model="rptPassword" required><br>
    <b><label >Enter your adress: </label></b><br>
    <input id="adress" type="text" name="adress" maxlength="25" v-model="addingAdress" required><br>
    <b><label>Enter your phone number:(+381) </label></b><br>
    <input id="phone" type="number" name="phone" max="2147483645" min="0" v-model="addingPhone" required><br>
